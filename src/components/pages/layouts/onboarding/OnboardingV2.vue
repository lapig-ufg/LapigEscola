<template>
    <div class="onboarding-wrapper onboarding-v2">
      <div class="title-wrap">
        <p>Lapig/GeoCodeLabs</p>
        <h2 class="dark-inverted">
          Bem-Vindo no MapBiomas na Escola
        </h2>
      </div>
        ...
        <div class="onboarding-wrap-inner">
          ...
          <div class="onboarding-card">
            ...
            <div class="onboarding-content">
              ...
              <p>
                A plataforma do professor é a forma mais fácil de
                compartilhar suas experiências com os alunos e com outros professores.
              </p>
          ...
          <div class="onboarding-card">
            ...
            <div class="onboarding-content">
              ...
              <p>
                Venha aprender mais sobre os biomas do brasil
              </p>
              <div class="button-wrap">
                <VButton
                  color="primary"
          ...
          <div class="onboarding-card">
            ...
            <div class="onboarding-content">
              ...
              <p>
                Sobre a iniciativa MapBiomas na escola e nossa equipe
              </p>
              <div class="button-wrap">
                <VButton
                  color="primary"
