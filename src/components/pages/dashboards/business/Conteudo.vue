...
onBeforeMount(
  () =>{
    for (const tema in temaAmbiental.temas){
      temaAmbiental.setTemas(tema)
    }
...
<template>
  <div class="dashboard-map-wrapper">
    ...
    >
      ...
      >
        <div
          class="content-tema-ambintal"
          v-for="tema in temaAmbiental.temas"
          :key="tema.nickname"


          @mouseover="temaAmbiental.setTemaByID(tema.nickname)"
        >

          <h2
            :ref="tema.nickname"
            :tabindex="tema.id"
            :id="'title-'+tema.nickname"
          >
            {{ tema.name }}
          </h2>
        <VMarkdownPreview
          ...
          >
            ...
            >
                ...
                <VButton
                  ...
                  @click="temaAmbiental.setFocos(tema.nickname)"
                >
                  {{ tema.name }}
                </VButton>
            </VControl>
